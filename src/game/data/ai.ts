...
export const AI_TIERS: AiTierDef[] = [
  ...
  { tier: 4, name: 'AI Agent', icon: '🧭', description: '스스로 계획을 세우고 테스트까지 돌린다.', cost: 12000000, requiredLevel: 14, devSpeedMult: 2.2, costReduction: 0.2, successBonus: 0.4, incomeMult: 1.45, color: '#ff7a59', orbs: 2 },
